...
conversation_detail = ConversationViewSet.as_view({"get": "retrieve", "delete": "destroy"})
...
urlpatterns = [
    ...
    path("conversations/<int:pk>/messages/", conversation_message, name="ai-conversation-message"),
]
