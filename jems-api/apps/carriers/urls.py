...
carrier_detail = CarrierViewSet.as_view({"get": "retrieve", "put": "update", "delete": "destroy"})
...
urlpatterns = [
    ...
    path("<int:pk>/toggle-status/", carrier_toggle_status, name="carrier-toggle-status"),
