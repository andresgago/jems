...
broker_detail = BrokerViewSet.as_view({"get": "retrieve", "put": "update", "delete": "destroy"})
...
contact_detail = BrokerContactViewSet.as_view({"get": "retrieve", "put": "update", "delete": "destroy"})
...
urlpatterns = [
    ...
    path("<int:broker_pk>/contacts/<int:pk>/", contact_detail, name="broker-contact-detail"),
]
