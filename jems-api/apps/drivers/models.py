...
class Driver(models.Model):
    ...
    driver_type = models.ForeignKey(
        DriverType, null=True, blank=True, on_delete=models.SET_NULL, related_name="drivers"
    )
    ...
    license_state = models.ForeignKey(
        "locations.State", null=True, blank=True, on_delete=models.SET_NULL, related_name="drivers"
    )
    license_file = models.FileField(upload_to="drivers/licenses/", null=True, blank=True)
    license_expiration = models.DateField(null=True, blank=True)

    # Medical card
    medical_card_file = models.FileField(upload_to="drivers/medical_cards/", null=True, blank=True)
    medical_card_expiration = models.DateField(null=True, blank=True)

    # Documents
    residence_card_file = models.FileField(upload_to="drivers/residence_cards/", null=True, blank=True)
    application_file = models.FileField(upload_to="drivers/applications/", null=True, blank=True)
    lease_agreement_file = models.FileField(upload_to="drivers/lease_agreements/", null=True, blank=True)
    mvr_file = models.FileField(upload_to="drivers/mvr/", null=True, blank=True)
    mvr_expiration = models.DateField(null=True, blank=True)
    social_security_file = models.FileField(upload_to="drivers/social_security/", null=True, blank=True)
    ...
    fuel_card = models.ForeignKey(
        "fleet.Card", null=True, blank=True, on_delete=models.SET_NULL, related_name="drivers"
    )
    team_driver = models.ForeignKey(
        "self", null=True, blank=True, on_delete=models.SET_NULL, related_name="team_partners"
    )
    carrier = models.ForeignKey(
        "carriers.Carrier", null=True, blank=True, on_delete=models.SET_NULL, related_name="drivers"
    )
    ...
    created_by = models.ForeignKey(
        "users.User", null=True, blank=True, on_delete=models.SET_NULL, related_name="created_drivers"
    )
...
class DriverVacation(models.Model):
    driver = models.ForeignKey(Driver, on_delete=models.CASCADE, related_name="vacations")
