...
function buyStatusClass(debtor_buy_status) {
  return BUY_STATUS_CLASS[debtor_buy_status] || '';
}
...
export default function BrokersStatusModal({ onClose }) {
      ...
      <div className="modal-dialog modal-xl">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Find broker</h5>
